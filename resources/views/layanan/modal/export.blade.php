        ...
        <div class="modal-content shadow-lg rounded">
            ...
            <div class="modal-body text-center py-4">
                <div class="mb-3">
                    ...
                    <p class="text-muted">
                        Unduh data layanan laundry dalam format Excel dengan sekali klik.
                    </p>
                </div>

                <a href="{{ route('layananExport') }}" class="btn btn-primary px-4 py-2 fw-bold">
                    <i class="fa fa-download mr-2"></i> Download Layanan Excel
                </a>
            </div>
        </div>
    </div>
